const introContent = {
  EN: {
    ...
    contact: 'Contact',
    welcome: 'Welcome to bmstack.eu',
    kicker: 'No cookies / no tracking / no analytics',
    headlineStart: 'Data science',
    headlineJoin: '& data',
  ...
  SK: {
    ...
    contact: 'Kontakt',
    welcome: 'Vitajte na bmstack.eu',
    kicker: 'Bez cookies / bez sledovania / bez analytiky',
    headlineStart: 'Data science',
    headlineJoin: '& data',
    headlineAccent: 'engineering',
    intro:
